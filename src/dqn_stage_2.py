...
class ReinforceAgent():
    def __init__(self, state_size, action_size):
        ...
        if self.load_model:
            self.model.set_weights(load_model(self.dirPath+'/save_model/stage_02/'+local_name+'/'+'src'+str(self.load_episode)+".h5").get_weights())

            with open(self.dirPath+'/save_model/stage_02/'+local_name+'/'+'src'+str(self.load_episode)+'.json') as outfile:
...
def save_data(E, R, T, C, G, A):
    ...
    file = open(dirPath + '/save_file/stage_02/training_dqn_stage02.csv', 'a+')
...
def save_test(T, E, C, G, TT):
    ...
    file = open(dirPath + '/save_file/stage_02/test_dqn_stage02-new.csv', 'a+')
    writer = csv.writer(file)
...
if __name__ == '__main__':
    rospy.init_node('deepbot_dqn_stage_2')
    ...
    if training:
        ...
        for e in range(agent.load_episode + 1, EPISODES):
            ...
            total_reward += score
            avg_reward = total_reward/e

            save_data(e, score, c_timeout, c_collision, c_goal, avg_reward)
