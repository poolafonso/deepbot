...
class ReinforceAgent():
    def __init__(self, state_size, action_size):
        ...
        if self.load_model:
            self.model.set_weights(load_model(self.dirPath+'/save_model/stage_04/'+local_name+'/'+'episode_'+str(self.load_episode)+".h5").get_weights())

            with open(self.dirPath+'/save_model/stage_04/'+local_name+'/'+'episode_'+str(self.load_episode)+'.json') as outfile:
...
def save_data(E, R, T, C, G, A):
    ...
    file = open(dirPath + '/save_file/stage_04/dqn_stage04.csv', 'a+')
...
def save_test(T, E, C, G, TT):
    ...
    file = open(dirPath + '/save_file/stage_04/test_dqn_stage04b.csv', 'a+')
    writer = csv.writer(file)
...
if __name__ == '__main__':
    rospy.init_node('deepbot_dqn_stage_4')
