...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(50, 50, 505, 650)
    ...
    def plot(self):
        self.qValuePlt = pg.PlotWidget(self, title="Average reward")
        self.qValuePlt.move(0, 320)
        self.qValuePlt.resize(500, 300)
        self.timer1 = pg.QtCore.QTimer()
        self.timer1.timeout.connect(self.update)
        self.timer1.start(200)

        self.rewardsPlt = pg.PlotWidget(self, title="Episode reward")
        self.rewardsPlt.move(0, 10)
        self.rewardsPlt.resize(500, 300)
